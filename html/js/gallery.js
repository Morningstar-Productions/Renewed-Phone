...
$(document).on('click', '#delete-button', function(e){
    ...
    setTimeout(() => {
        $.post('https://Renewed-Phone/DeleteImage', JSON.stringify({image:source}), function(Hashtags){
            setTimeout(()=>{
                $('#return-button').click()
...
$(document).on('click', '#tweet-button', function(e){
    ...
    if (TweetMessage != "") {
        ...
        var TweetMessage = $("#new-textarea").val(' ');
        $.post('https://Renewed-Phone/GetHashtags', JSON.stringify({}), function(Hashtags){
