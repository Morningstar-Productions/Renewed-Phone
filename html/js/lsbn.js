...
LoadLSBNEvent = function() {
    var PlayerJob = QB.Phone.Data.PlayerData.job.type;
    ...
    $(".lsbn-list").html("");
    $.post(`https://${GetParentResourceName()}/GetLSBNchats`, JSON.stringify({}));
}
...
$(document).on('click', '#lsbn-submit-to-send-text', function(e){
    ...
    if((Text && Image) != ""){
        $.post(`https://${GetParentResourceName()}/Send_lsbn_ToChat`, JSON.stringify({
            Type: "Image",
            Text: Text,
            Image: Image,
            Time: Times,
